...
pub fn ContactForm(props: ContactFormProps) -> Element {
    ...
    let mut memo = use_signal(|| props.contact.as_ref().and_then(|c| c.memo.clone()).unwrap_or_default());
            ...
            form { onsubmit: handle_submit,
                ...
                div { class: "form-group",
                    ...
                    input {
                        ...
                        r#type: "email",
                        pattern: r"[^@\s]+@[^@\s]+\.[^@\s]+",
                        title: "이메일은 example@domain.com 형식이어야 합니다.",
                        value: "{email}",
                ...
                div { class: "form-group",
                    ...
                    input {
                        ...
                        pattern: r"(010-?\d{{4}}-?\d{{4}}|01[16789]-?\d{{3,4}}-?\d{{4}})",
                        title: "전화번호는 010-1234-5678 형식의 한국 휴대폰 번호여야 합니다.",
                        value: "{phone}",
                ...
                div { class: "form-group",
                    ...
                    textarea {
                        ...
                        rows: "3",
                        value: "{memo}",
                        oninput: move |evt| memo.set(evt.value())
                    }
                }
