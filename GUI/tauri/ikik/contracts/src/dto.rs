...
/// 화면과 커맨드 경계를 오가는 IKIK 항목 표현.
/// id는 UUID 문자열, 시각은 RFC3339 문자열로 고정한다.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct IkikItemDto {
    pub id: String,
    pub kind: ItemKind,
    ...
    /// 마감 기한(Key Performance Indicator는 목표 달성일). "YYYY-MM-DD".
    #[serde(default)]
...
/// title, description, target_value, unit, status, aggregation,
/// due_date)이고, 화면 레이블은 프런트엔드가 매긴다.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
