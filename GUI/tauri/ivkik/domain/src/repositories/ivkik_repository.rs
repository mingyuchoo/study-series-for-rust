...
pub trait IvkikRepository: ItemRepository + KpiMeasurementRepository + ItemRevisionRepository {}

impl<T> IvkikRepository for T where T: ItemRepository + KpiMeasurementRepository + ItemRevisionRepository + ?Sized {}
