...
impl IvkikService {
    pub async fn create_item(request: CreateItemRequest) -> Result<IvkikItem, String> { call("create_item", &serde_json::json!({ "request": request })).await }

    pub async fn list_items() -> Result<Vec<IvkikItem>, String> {
    ...
    pub async fn update_item(request: UpdateItemRequest) -> Result<IvkikItem, String> { call("update_item", &serde_json::json!({ "request": request })).await }
    ...
    pub async fn search_items(query: String) -> Result<Vec<IvkikItem>, String> {
        if !is_tauri_runtime_available() {
            return Ok(Vec::new());
        }
